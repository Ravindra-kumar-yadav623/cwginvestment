                ...
                <div class="card card-stats card-round">
                  <div class="card-body">
                    <div class="row align-items-center">
                      ...
                      <div class="col col-stats ms-3 ms-sm-0">
                        <div class="numbers">
                          <p class="card-category">New Withdrawal</p>
                ...
                <div class="card card-stats card-round">
                  <div class="card-body">
                    <div class="row align-items-center">
                      ...
                      <div class="col col-stats ms-3 ms-sm-0">
                        <div class="numbers">
                          <p class="card-category">New Deposit</p>
                          <h4 class="card-title">$200</h4>
                        </div>
                      </div>
                    </div>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex justify-content-between">
                      ...
                      <h4 class="text-success fw-bold">$1121</h4>
                    </div>
                    <div class="progress progress-sm">
                  ...
                  <div class="card-body">
                    <div class="d-flex justify-content-between">
                      <div>
                        ...
                        <p class="text-muted">Users Amount</p>
                      </div>
                      <h4 class="text-warning fw-bold">1151</h4>
                    </div>
                    <div class="progress progress-sm">
