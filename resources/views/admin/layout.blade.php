        ...
        <div class="container">
			...
			<div class="col-md-12">
                <div class="card">
                  <div class="card-header">
                    <h4 class="card-title">Pramod Kumar Gupta</h4>
					<p> India</p>
                  </div>				  
                </div>
              </div>
          ...
          <div class="container-fluid d-flex justify-content-between">
            <nav class="pull-left">
              <ul class="nav">
                <li class="nav-item">
                  <a class="nav-link" href="http://www.themekita.com"> CWG </a>
                </li>
                <li class="nav-item">
            ...
            <div class="copyright"> 2000, made with <i class="fa fa-heart heart text-danger"></i> by <a href="http://www.themekita.com">CWG</a>
            </div>
            <div> Distributed by <a target="_blank" href="https://themewagon.com/">CWG</a>. </div>
          </div>
        </footer>
