                ...
                <div class="d-flex mb-3">
                    <div class="input-group mb-3 input-primary">
                        ...
                        <a onclick="navigator.clipboard.writeText(document.getElementById('refLink').value)"
                            class="input-group-text" style="cursor:pointer;">Copy Referral Link</a>
                    </div>
                </div>
            </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        const canvas = document.getElementById('referChart');
        if (!canvas) return;
        ...
        new Chart(ctx, {
            ...
            options: {
                responsive: true,
                maintainAspectRatio: true, // allow fixed height
                animation: {
                    ...
                    tooltip: {
                        ...
                        callbacks: {
                            label: function(context) {
                                return `Joined: ${context.raw} users`;
                            }
                        }
                    },
                    legend: {
                        display: false // hide top label
                    }
                },
                hover: {
                    mode: 'nearest',
